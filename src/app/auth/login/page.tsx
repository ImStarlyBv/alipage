    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-8">
      <div className="w-full max-w-sm space-y-5 rounded-xl bg-beige p-6 shadow-sm sm:space-y-6 sm:p-8">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-full border border-primary/20 bg-white py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-gray-50"
        >
